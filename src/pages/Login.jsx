...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (accounts.find(item => item.login === loginRef.current.value && accounts.find(item => item.login === loginRef.current.value).password === passwordRef.current.value)) {
            navigate('/dashboard')
        } else {
        ...
        <form className='p-4 shadow-[0_0_30px_0_#0129701A] rounded-[8px] lg:w-[408px]' onSubmit={handleSubmit}>
            ...
            <div className='mb-4'>
                ...
                <div className='flex'>
                    ...
                    <input ref={loginRef} type="text" id="username" className='rounded-none rounded-e-lg bg-gray-50 border focus:ring-blue-500 focus:border-blue-500 block flex-1  min-w-0 w-full text-sm border-gray-300 p-2.5'  />
                </div>
            </div>
            <div className='mb-4'>
                <label htmlFor="password" className='block mb-2'>Parol</label>
                <input ref={passwordRef} type="password" id='password' className='bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 ' />
            </div>
